...
public class ComputeImpliedVol extends JFrame {

  JFrame mainFrame;
  BSOption optionCall;
  BSOption optionPut;

  public ComputeImpliedVol(double s, double k, double t, double r, double q, double optionprice) {
    optionCall = new BSOption(s, k, t, r, q, 0, optionprice, 'c');
    optionPut = new BSOption(s, k, t, r, q, 0, optionprice, 'p');

    // create window
    JFrame mainFrame = new JFrame("Calculating the Implied volatility of a Call and Put");
    ...
    //// label for CALL
    JLabel callLabel = new JLabel("CALCULATING IMPLIED VOLATILITY OF A CALL OPTION");
    callLabel.setBounds(300, 5, 600, 30);
    ...
    enterLabel.setBounds(33, 50, 400, 30);
    ...
    JLabel resultLabel = new JLabel("The implied volatility of your call is ");
    resultLabel.setFont(new Font("Calibri", Font.BOLD, 15));
    resultLabel.setBounds(683, 150, 300, 40);
    mainFrame.add(resultLabel);
    resultLabel.setVisible(true);
    JLabel resultPriceCall = new JLabel(String.valueOf(optionCall.ImpliedVol_NewtonRaphson(optionCall.price, 0.05, 300, Math.pow(10,-3))));
    ...
    param1.addActionListener(new ActionListener() {
       public void actionPerformed(ActionEvent e) {
          ...
          resultPriceCall.setText(String.valueOf(optionCall.ImpliedVol_NewtonRaphson(optionCall.price, 0.05, 300, Math.pow(10,-3))));
       }
    });
    ...
    //// OPTION PRICE
    JLabel paramtext4 = new JLabel("Option's Price:  ");
    ...
    param4.setText(String.valueOf(optionCall.price));
    param4.addActionListener(new ActionListener() {
       public void actionPerformed(ActionEvent e) {
          optionCall.price = Double.parseDouble(param4.getText());
          resultPriceCall.setText(String.valueOf(optionCall.ImpliedVol_NewtonRaphson(optionCall.price, 0.05, 300, Math.pow(10,-3))));
       }
    });
    ...
    //// label for PUT
    JLabel putLabel = new JLabel("CALCULATING IMPLIED VOLATILITY OF A PUT OPTION");
    putLabel.setBounds(300, 340, 600, 30);
    ...
    JLabel resultLabelPut = new JLabel("The implied volatility of your put is  ");
    resultLabelPut.setFont(new Font("Calibri", Font.BOLD, 15));
    resultLabelPut.setBounds(685, 490, 300, 40);
    mainFrame.add(resultLabelPut);
    resultLabelPut.setVisible(true);
    JLabel resultPricePut = new JLabel(String.valueOf(optionPut.ImpliedVol_NewtonRaphson(optionPut.price, 0.05, 300, Math.pow(10,-3))));
    ...
    param1b.addActionListener(new ActionListener() {
       public void actionPerformed(ActionEvent e) {
          ...
          resultPricePut.setText(String.valueOf(optionPut.ImpliedVol_NewtonRaphson(optionPut.price, 0.05, 300, Math.pow(10,-3))));
       }
    });
    ...
    //// VOLATILITY
    JLabel paramtext4b = new JLabel("Option's Price:  ");
    ...
    param4b.setText(String.valueOf(optionPut.price));
    param4b.addActionListener(new ActionListener() {
       public void actionPerformed(ActionEvent e) {
          optionPut.price = Double.parseDouble(param4b.getText());
          resultPricePut.setText(String.valueOf(optionPut.ImpliedVol_NewtonRaphson(optionPut.price, 0.05, 300, Math.pow(10,-3))));
       }
    });
